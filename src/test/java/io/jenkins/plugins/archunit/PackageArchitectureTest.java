...
@AnalyzeClasses(packages = "io.jenkins.plugins.metrics", importOptions = DoNotIncludeTests.class)
final class PackageArchitectureTest {
    ...
    static final ArchRule ADHERES_TO_PACKAGE_DESIGN
            ...
            consideringOnlyDependenciesInAnyPackage("io.jenkins.plugins.metrics..")));
